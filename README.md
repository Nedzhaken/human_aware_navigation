...
If you are considering using this code, please reference the following ([paper](https://hal.science/hal-04526492)):
...
We evaluated the social properties of the above methods from both the robot and human perspectives. For the latter we used the **Robotic Social Attributes Scale (RoSAS)** questionnaire: https://forms.gle/4Lr4KP1E81SJFAET9. Details on this part can be found in our [paper](https://arxiv.org/abs/2210.15628):
